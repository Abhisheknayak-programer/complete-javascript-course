...
})({"1DYC3":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 62963;
...
// /////////////////////////////////////
const LoadSpinner = ParentElement => {
  const markup = `
  <div class="spinner">
        <svg>
...
const ShowRecipe = async () => {
  try {
    ...
    let recipe = recipe__data.data.recipe;
    recipe = {
      id: recipe.id,
      title: recipe.title,
    ...
    recipeContainer.insertAdjacentHTML('afterbegin', recipe_html);
    console.log(recipe);
  } catch (error) {
    alert(error);
  }
...
},{"../internals/export":"7f5VM"}]},["1DYC3","3miIZ"], "3miIZ", "parcelRequire37be")
